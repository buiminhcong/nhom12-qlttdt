...
<body style="padding: 10px 24px">
	...
	<%
		...
		List<Integer> listIDLichDay = phieuDangkiDAO.getIDLichDayByIDHocVien(id);
  ...
  <path fill-rule="evenodd"
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link" href="#">Thời
						khóa biểu</a></li>
	...
	<div class="container pt-5">
		<div class="row mt-5">
			...
			<div
				...
				<div class="card-body">
					<h2 class="text-center font-italic">Các Khóa học bạn đã đăng ký</h2>
					<hr>
					<div class="row">
						<ul>
					...
					<table class="table">
						...
						<tbody>
							...
							<%
								int i = 1;
								for (Integer count : listIDLichDay) {
									LichDay ld = lichDayDAO.getTKB(count);
							%>
							<tr>
								<th scope="row"><%=i++%></th>
								...
								<td><%=ld.getPhongHoc().getTen()%></td>
								<td><%=ld.getKhoaHoc().getThoiGianBatDau()%></td>
								<td>
									<form action="xoa.jsp" method="POST">
										<input type="text" name="idTKB"
											value="<%=ld.getId()%>" hidden>
