...
<body>
	...
	<%
		...
		ArrayList<KhoaHoc> listKhoaHoc = new KhoaHocDAO().getTatCaKhoaHoc();
		System.out.println(listKhoaHoc.size());
    ...
    <div class="row mt-5">
      ...
      <div class="card col-md-10 shadow-lg p-3 mb-5 bg-white rounded border-0">
        <div class="card-body">
          ...
          <div class="row">
            <ul>
              <li><em>Mã hoc vien: </em><strong>MB12</strong></li>
              <li><em>Họ và tên: </em><strong>le quang An</strong></li>
