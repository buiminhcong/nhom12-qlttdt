...
<body style="padding: 10px 24px">
	...
	<%
		...
		MonHoc_KhoaHocDAO mh_khDAO = new MonHoc_KhoaHocDAO();
		MonHoc_KhoaHoc mh_kh = new MonHoc_KhoaHoc();

		String tenKhoaHoc = request.getParameter("tenkhoahoc");
		tenKhoaHoc =  tenKhoaHoc.trim().toLowerCase();
		List<Integer> idKHList = khoaHocDAO.getIdKhoaHocByTenKhoaHoc(tenKhoaHoc) ;
				...
				<div class="card-body">
					...
					<table class="table">
						...
						<tbody>
							...
							<%
								int i = 1;
								for (Integer c : idKHList) {
									mh_kh = mh_khDAO.getKhoaHocByIdKhoaHoc(c);
							%>
							<tr>
								<th scope="row"><%=i++%></th>
