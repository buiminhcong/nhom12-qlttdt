...
<body>
	...
	<div style="padding: 50px" class="row no-gutters bg-light position-relative">
		<div class="col-md-6 mb-md-0 p-md-4">
			<img src="static/images/KhoaHoc.jpg" class="w-100" alt="...">
		</div>
		<div class="col-md-6 position-static p-4 pl-md-0">
			<h5 class="mt-0">Danh Sách các khóa học</h5>
			<p>Chúng tôi cung cấp các khóa học lập trình, bạn có thể chọn các khóa 
			học từ cơ bản đến nâng cao phù hợp với bản thân. xem khóa học tại đây</p>
