...
<body style="padding: 10px 24px">
	...
	<%
		...
		int idKhoaHoc = Integer.parseInt(request.getParameter("khoahocid"));
		
		KhoaHoc kh = khDAO.getKhoaHocByID(idKhoaHoc);
				...
				<div class="col-12 col-lg-9 col-xl-7">
					<div class="card shadow-2-strong card-registration"
						...
						<div class="card-body p-4 p-md-5">
							...
							<form action="gdSuaThanhCong.jsp" method="post">
								<div class="row">
									<div class="col-md-6 mb-4">

										<input value="<%=kh.getID()%>" name="ID_KH" type="hidden" id="firstName"
												class="form-control form-control-lg" />
										
										<div class="form-outline">
											<input value="<%=kh.getTen()%>" name="ten" type="text" id="firstName"
									...
									<div class="col-md-6 mb-4">
										...
										<div class="form-outline">
											<input value="<%=kh.getMoTa()%>" name="mota" type="text" id="lastName"
												class="form-control form-control-lg" /> <label
								...
								<div class="row">
									<div class="col-md-6 mb-4">
										...
										<div class="form-outline">
											<input value="<%=kh.getHocPhi()%>" name="hocphi" type="text" id="firstName"
												class="form-control form-control-lg" /> <label
									...
									<div class="col-md-6 mb-4">
										...
										<div class="form-outline">
											<input value="<%=kh.getSiSoToiDa()%>" name="siso" type="text" id="lastName"
												class="form-control form-control-lg" /> <label
								...
								<div class="row">
									<div class="col-md-6 mb-4">
										...
										<div class="form-outline">
											<input value="<%=kh.getThoiGianBatDau()%>" name="bd" placeholder="yyyy-MM-dd" type="text" id="firstName"
												class="form-control form-control-lg" /> <label
									...
									<div class="col-md-6 mb-4">
										...
										<div class="form-outline">
											<input value="<%=kh.getThoiGianKetThuc()%>" name="kt" placeholder="yyyy-MM-dd" type="text" id="lastName"
												class="form-control form-control-lg" /> <label
