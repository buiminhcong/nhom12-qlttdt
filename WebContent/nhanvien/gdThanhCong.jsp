...
<body style="padding: 10px 24px">
	...
	<%
		...
		List<MonHoc> list_mh = mhDAO.getDSMonHoc();
		...
		System.out.println( khDAO.luuKhoaHoc(idNV, ten, mota, hocphi, ss, kthtInt, thoigianBD, thoigianKT, lvID) );
  ...
  <path fill-rule="evenodd"
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link" href="gdXemKH.jsp">Các
						khóa học</a></li>
				<li class="nav-item active"><a class="nav-link"
	...
	<h1 class="text-success">Lưu Thành công</h1>
